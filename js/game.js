...
function handleMenuClick(event){
  // Deliberately empty: Only allow restart via submitScore()
}
...
function loop(){
  ...
  airplane.propeller.rotation.x += 0.05 + game.planeSpeed * deltaTime * .001; // Slower rotation
...
function updatePlane(){
  ...
  camera.position.y += (airplane.mesh.position.y - camera.position.y)*0.1;

  game.planeCollisionSpeedX += (0-game.planeCollisionSpeedX)*0.2;
  game.planeCollisionDisplacementX += (0-game.planeCollisionDisplacementX)*0.2;
  game.planeCollisionSpeedY += (0-game.planeCollisionSpeedY)*0.2;
  game.planeCollisionDisplacementY += (0-game.planeCollisionDisplacementY)*0.2;
